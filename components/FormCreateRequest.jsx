...
function FormCreateRequest() {
  ...
  let handleSubmit = async (e) => {
    ...
    if (title.length < 4) {
      ...
      puertosElectricos < 0 ||
      puertosOpticos1gb < 0 ||
      puertosOpticos10gb < 0 ||
      puertosOpticos100gb < 0
    ) {
  ...
  return (
    <Form onSubmit={handleSubmit}>
      ...
      <Row className="mb-3">
        ...
        <Form.Group as={Col} md="4">
          ...
          >
            ...
            <option value="Optimización">Optimización - Gonzalo Bacelli</option>
      ...
      <Row className="mb-3">
        <p>
          <strong>Comentario:</strong> Indicar total de puertos a conectar, si
          indica tipo de conexión <em>"Dual Homed"</em> los puertos se dividiran
          entre los 2 PE del sitio.
        </p>
